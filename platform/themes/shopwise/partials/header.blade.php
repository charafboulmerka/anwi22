...
<html lang="{{ app()->getLocale() }}">
    ...
    @php
        $categoriesWith = array_merge(['slugable', 'activeChildren', 'activeChildren.slugable', 'metadata'], (is_plugin_active('language-advanced') ? ['children.translations'] : []));
                                        ...
                                        <div class="custom_select">
                                            <select name="categories[]" class="first_null">
                                                ...
                                                @foreach (ProductCategoryHelper::getProductCategoriesWithIndent() as $category)
                                                    <option value="{{ $category->id }}" @if (in_array($category->id, [Arr::first(request()->input('categories', []))])) selected @endif>{!! $category->indent_text !!} {{ $category->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
