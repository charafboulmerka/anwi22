...
var MenuNestable = /*#__PURE__*/function () {
  ...
  _createClass(MenuNestable, [{
    ...
    value: function handleNestableMenu() {
      ...
      $(document).on('change blur keyup', '.nestable-menu .item-details input, .nestable-menu .item-details select', function (e) {
        e.preventDefault();
        ...
        var currentInfo = $.parseJSON(JSON.stringify(parent.data('menu-item')));
      ...
      $(document).on('click', '.box-links-for-menu .btn-add-to-menu', function (e) {
        ...
        if (parent.attr('id') === 'external_link') {
          $('#menu-node-create-form').find('input, textarea, select').serializeArray().map(function (x) {
            params[x.name] = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(x.value);
          });
          ...
          parent.find('.list-item li.active').each(function (index, el) {
            ...
            params.reference_type = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(find_in.data('reference-type'));
            params.reference_id = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(find_in.data('reference-id'));
            params.title = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(find_in.data('title'));
            params.menu_id = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(find_in.data('menu-id'));
      ...
      var createMenuNode = function createMenuNode(params, current, parent) {
        $.ajax({
      ...
      $(document).on('click', '.nestable-menu .item-details .btn-cancel', function (e) {
        ...
        parent.find('input, textarea, select').each(function (index, el) {
